  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label className="block text-gray-600 mb-2" htmlFor="ip">
            Base IP Address:
          </label>
          <input
            id="ip"
        ...
        <div className="mb-4">
          <label className="block text-gray-600 mb-2" htmlFor="originalMask">
        ...
        <div className="mb-6">
          <label className="block text-gray-600 mb-2" htmlFor="numSubnets">
            Number of Subnets:
          </label>
          <input
            id="numSubnets"
